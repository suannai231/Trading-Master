...
def screen(df):
    ...
    if (close>=ema5) and (ema5 >= ema10) and (ema10 >= ema20) and (ema20 >= ema60) and (ema60 >= ema150) and (OBV_60_MAX>OBV>=OBV_60_MAX*0.90) and (turnover >= 100000):
        return df.tail(1)
...
if __name__ == '__main__':
    ...
    return_df.to_csv(screened_data_path + f'{end}' + '_wait.csv')