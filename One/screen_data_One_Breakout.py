...
def screen(df,lines):
    ...
    #         return False
        ...
        ready = Long_Diff>=Pre_Long_Diff and Long_Diff>=Long_Diff_EMA20>=Short_Diff_EMA20>=Short_Diff
...
def run_last_20_days(ticker_chunk_df):
    ...
    for ticker in tickers:
        ...
        for i in range(df_len-19, df_len+1):
            ...
            if screen(slice_df,'AMP40'):
                AMP40 = True
            AMP10 = screen(slice_df,'AMP10')

            if((i==df_len) and AMP40 and AMP10):
