...
TURN_RATE_LOW = 0.05
CUM_TURN_RATE_25 = 0
CUM_TURN_RATE_75 = 1.15 # tested RCMT HX
WR21_HIGH = 50
WR21_LOW = 0
WR42_HIGH = 50
WR42_LOW = 0
...
def screen(df):
    ...
    if CLOSE_ABOVE_EMA & ((df['close'][lastindex] < df['EMA5'][lastindex]) | (df['EMA5'][lastindex] < df['EMA10'][lastindex]) | (df['EMA10'][lastindex] < df['EMA20'][lastindex]) | (df['EMA20'][lastindex] < df['EMA60'][lastindex])):
        return pd.DataFrame()
